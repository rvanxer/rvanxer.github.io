...
\address{+1(517)481-0901 \\
\href{mailto:verma99@purdue.edu}{verma99@purdue.edu} \\
\href{https://rvanxer.github.io}{rvanxer.github.io} \\
\href{https://www.linkedin.com/in/rajat-verma-msu}{LinkedIn} \\
\href{https://scholar.google.com/citations?user=eUl1nl8AAAAJ&hl}{Google Scholar}} % phone number and email
\address{Lyles School of Civil and Construction Engineering} % primary address
...
\begin{rSection}{Technical Strengths}
    ...
    \begin{spacing}{1.25}
    \begin{tabbing}
        General programming: \hspace*{0.75cm} \=
            \href{https://en.wikipedia.org/wiki/Bash_(Unix_shell)}{Bash}$^*$,
            \href{https://en.wikipedia.org/wiki/Git}{Git}$^*$,
            ...
            \href{https://en.wikipedia.org/wiki/Project_Jupyter}{Jupyter}$^*$,
        ...
        \\ Data manipulation: \>
            \href{https://en.wikipedia.org/wiki/Dask_(software)}{Dask},
            \href{https://en.wikipedia.org/wiki/Dplyr}{dplyr}$^*$,
            \href{https://en.wikipedia.org/wiki/Microsoft_Excel}{Excel}$^*$,
            \href{https://en.wikipedia.org/wiki/NumPy}{NumPy}$^*$,
            \href{https://en.wikipedia.org/wiki/Pandas_(software)}{pandas}$^*$,
            py\href{https://en.wikipedia.org/wiki/Apache_Spark}{Spark}$^*$,
            \href{https://en.wikipedia.org/wiki/SciPy}{SciPy}$^*$
        \\ Data visualization: \>
            \href{https://en.wikipedia.org/wiki/Gephi}{Gephi},
            \href{https://en.wikipedia.org/wiki/Ggplot2}{ggplot2},
            \href{https://en.wikipedia.org/wiki/Leaflet_(software)}{Leaflet},
            \href{https://en.wikipedia.org/wiki/Matplotlib}{Matplotlib}$^*$,
            \href{https://plotly.com/}{Plotly}$^*$,
            \href{https://en.wikipedia.org/wiki/Shiny_(web_framework)}{Shiny},
            \href{https://en.wikipedia.org/wiki/Tableau_Software}{Tableau}$^*$
        \\ Geospatial analysis: \>
            \href{https://en.wikipedia.org/wiki/ArcGIS_Pro}{ArcGIS Pro}$^*$,
            \href{https://geodacenter.github.io/}{GeoDa},
            \href{https://geopandas.org/en/stable/}{geopandas}$^*$,
            \href{https://project-osrm.org/}{OSRM}$^*$,
            \href{https://pyrosm.readthedocs.io/en/latest/}{pyrosm}$^*$,
